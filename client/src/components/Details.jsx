...
const Details = (props) => {
          ...
          <div className="card text-center mb-4">
            <div className="card-body">
              ...
              <p className="card-text">
                <p>
                  <em><svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 640 512"><path d="M176 256c44.11 0 80-35.89 80-80s-35.89-80-80-80-80 35.89-80 80 35.89 80 80 80zm352-128H304c-8.84 0-16 7.16-16 16v144H64V80c0-8.84-7.16-16-16-16H16C7.16 64 0 71.16 0 80v352c0 8.84 7.16 16 16 16h32c8.84 0 16-7.16 16-16v-48h512v48c0 8.84 7.16 16 16 16h32c8.84 0 16-7.16 16-16V240c0-61.86-50.14-112-112-112z"/></svg>

                    {""} Bedrooms</em>: {" "}{home.numberOfBedrooms}</p>
                <p> 
                <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512"><path d="M96 77.3c0-7.3 5.9-13.3 13.3-13.3c3.5 0 6.9 1.4 9.4 3.9l14.9 14.9C130 91.8 128 101.7 128 112c0 19.9 7.2 38 19.2 52c-5.3 9.2-4 21.1 3.8 29c9.4 9.4 24.6 9.4 33.9 0L289 89c9.4-9.4 9.4-24.6 0-33.9c-7.9-7.9-19.8-9.1-29-3.8C246 39.2 227.9 32 208 32c-10.3 0-20.2 2-29.2 5.5L163.9 22.6C149.4 8.1 129.7 0 109.3 0C66.6 0 32 34.6 32 77.3V256c-17.7 0-32 14.3-32 32s14.3 32 32 32H480c17.7 0 32-14.3 32-32s-14.3-32-32-32H96V77.3zM32 352v16c0 28.4 12.4 54 32 71.6V480c0 17.7 14.3 32 32 32s32-14.3 32-32V464H384v16c0 17.7 14.3 32 32 32s32-14.3 32-32V439.6c19.6-17.6 32-43.1 32-71.6V352H32z"/></svg>
                  {""} Bathrooms: {" "}{home.numberOfBathrooms}</p>
        ...
        <div className="col">
          <div className="card text-center mb-3 fs-5">
            <div className="card-body">
              ...
              <p><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="green" class="bi bi-check-circle-fill" viewBox="0 0 16 16">
          ...
          <div className="card text-center mb-3">
            <div className="card-body">
              ...
              <div className="bills">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="grey" class="bi bi-cash" viewBox="0 0 16 16">
  ...
  <path d="M0 4a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V4zm3 0a2 2 0 0 1-2 2v4a2 2 0 0 1 2 2h10a2 2 0 0 1 2-2V6a2 2 0 0 1-2-2H3z"/>
              ...
              <div className="tenancy">
                <h5 className="card-text">
                <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="grey" class="bi bi-person-fill" viewBox="0 0 16 16">
  <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3Zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z"/>
                ...
                {home.maxTenants}</p>
                <p> Tenancy Length: {""}
              {home.tenancylength}</p>
              </div>
              </div>
              <div className="">
                <h5 className="card-text"> <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="grey" class="bi bi-card-list" viewBox="0 0 16 16">
  ...
  <path d="M5 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 5 8zm0-2.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zm0 5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zm-1-5a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0zM4 8a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0zm0 2.5a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0z"/>
                ...
                <p>Furnishing :{""}{home.furnishing}</p>
                </div>
          ...
          <div className="card text-center mb-3">
            <div className="card-body">
              ...
              <p className="card-text">
                ...
                content.Cards include a few options for working with images.
                Choose from appending “image caps” at either end of a card,
